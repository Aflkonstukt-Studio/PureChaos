...
public class Modelfish<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("purechaos", "modelfish"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftFin = body_front.addOrReplaceChild("leftFin", CubeListBuilder.create().texOffs(2, 0).addBox(-2.0075F, -2.867F, 0.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -1.0F, 0.0F, 0.0F, 0.0F, 0.6109F));
		PartDefinition rightFin = body_front.addOrReplaceChild("rightFin", CubeListBuilder.create().texOffs(-2, 0).addBox(0.0074F, -2.867F, 0.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -1.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		body_front.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
	}
}
