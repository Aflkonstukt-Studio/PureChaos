...
public class PurechaosModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<JGWarningMenu>> JG_WARNING = REGISTRY.register("jg_warning", () -> IMenuTypeExtension.create(JGWarningMenu::new));
}
