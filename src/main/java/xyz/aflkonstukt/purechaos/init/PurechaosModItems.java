...
public class PurechaosModItems {
	...
	public static final RegistryObject<Item> PEE_BLOCK = block(PurechaosModBlocks.PEE_BLOCK);
	...
	public static final RegistryObject<Item> AENTITY_SPAWN_EGG = REGISTRY.register("aentity_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AENTITY, -13434625, -10040065, new Item.Properties()));
	...
	public static final RegistryObject<Item> POTATUS = block(PurechaosModBlocks.POTATUS);
	...
	public static final RegistryObject<Item> TRIDENT_SPAWN_EGG = REGISTRY.register("trident_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.TRIDENT, -13641874, -1, new Item.Properties()));
	public static final RegistryObject<Item> DEATH = block(PurechaosModBlocks.DEATH);
	public static final RegistryObject<Item> SA_DS = block(PurechaosModBlocks.SA_DS);
	public static final RegistryObject<Item> NETHERIT_PICKAX = REGISTRY.register("netherit_pickax", () -> new NetheritPickaxItem());
	public static final RegistryObject<Item> EMEPEE = block(PurechaosModBlocks.EMEPEE);
	...
	public static final RegistryObject<Item> SUS_BLOCK = block(PurechaosModBlocks.SUS_BLOCK);
	public static final RegistryObject<Item> CUM_BUCKET = REGISTRY.register("cum_bucket", () -> new CumItem());
	public static final RegistryObject<Item> AMONG_US_SPAWN_EGG = REGISTRY.register("among_us_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AMONG_US, -52429, -3394816, new Item.Properties()));
	public static final RegistryObject<Item> SUS = REGISTRY.register("sus", () -> new SusItem());
	public static final RegistryObject<Item> AMOGUS_2_SPAWN_EGG = REGISTRY.register("amogus_2_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AMOGUS_2, -26215, -52429, new Item.Properties()));
	public static final RegistryObject<Item> AMOGUS_3_SPAWN_EGG = REGISTRY.register("amogus_3_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AMOGUS_3, -52429, -39322, new Item.Properties()));
	public static final RegistryObject<Item> STARAVODA_BUCKET = REGISTRY.register("staravoda_bucket", () -> new StaravodaItem());
	public static final RegistryObject<Item> TLGHD = block(PurechaosModBlocks.TLGHD);
	...
	public static final RegistryObject<Item> GREEN_PLANT = block(PurechaosModBlocks.GREEN_PLANT);
	...
	public static final RegistryObject<Item> JOSIPDVATOCKANULA_SPAWN_EGG = REGISTRY.register("josipdvatockanula_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.JOSIPDVATOCKANULA, -16777216, -65536, new Item.Properties()));
	...
	public static final RegistryObject<Item> JOSIP_PET_SPAWN_EGG = REGISTRY.register("josip_pet_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.JOSIP_PET, -3407668, -26113, new Item.Properties()));
	public static final RegistryObject<Item> JOSIP_PETT_SPAWN_EGG = REGISTRY.register("josip_pett_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.JOSIP_PETT, -65536, -10066330, new Item.Properties()));
	public static final RegistryObject<Item> MOTH_OF_AGGREVATION_SPAWN_EGG = REGISTRY.register("moth_of_aggrevation_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.MOTH_OF_AGGREVATION, -6737152, -1, new Item.Properties()));
	public static final RegistryObject<Item> BULLET = REGISTRY.register("bullet", () -> new BulletItem());
	public static final RegistryObject<Item> SHEP_SPAWN_EGG = REGISTRY.register("shep_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.SHEP, -1, -10066330, new Item.Properties()));
	public static final RegistryObject<Item> VIKKIVUK_SPAWN_EGG = REGISTRY.register("vikkivuk_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.VIKKIVUK, -13369345, -13408513, new Item.Properties()));
	public static final RegistryObject<Item> BLAZ_SPAWN_EGG = REGISTRY.register("blaz_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.BLAZ, -205, -39322, new Item.Properties()));
	public static final RegistryObject<Item> CURSED_DOG_SPAWN_EGG = REGISTRY.register("cursed_dog_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.CURSED_DOG, -1, -3355444, new Item.Properties()));
	public static final RegistryObject<Item> METH = REGISTRY.register("meth", () -> new MethItem());
	public static final RegistryObject<Item> WALTER_WIGHT_SPAWN_EGG = REGISTRY.register("walter_wight_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.WALTER_WIGHT, -16777012, -16777114, new Item.Properties()));
	public static final RegistryObject<Item> ADOLF_HITLER_SPAWN_EGG = REGISTRY.register("adolf_hitler_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.ADOLF_HITLER, -52429, -3407872, new Item.Properties()));
	public static final RegistryObject<Item> DREAM_SPAWN_EGG = REGISTRY.register("dream_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.DREAM, -13369549, -1, new Item.Properties()));
	public static final RegistryObject<Item> SCRATEST = REGISTRY.register("scratest", () -> new ScratestItem());
	public static final RegistryObject<Item> YOUTUBE = block(PurechaosModBlocks.YOUTUBE);
	public static final RegistryObject<Item> PLANTE = block(PurechaosModBlocks.PLANTE);
	public static final RegistryObject<Item> TESTICLE_ON_STICK = REGISTRY.register("testicle_on_stick", () -> new TesticleOnStickItem());
	public static final RegistryObject<Item> RICKROLL_BLOCK = block(PurechaosModBlocks.RICKROLL_BLOCK);
	public static final RegistryObject<Item> GRAVE = block(PurechaosModBlocks.GRAVE);
	...
	public static final RegistryObject<Item> COD_BUT_BETTER_SPAWN_EGG = REGISTRY.register("cod_but_better_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.COD_BUT_BETTER, -13312, -13108, new Item.Properties()));
	public static final RegistryObject<Item> BACKROOMS_LVL_1LIGHT = block(PurechaosModBlocks.BACKROOMS_LVL_1LIGHT);
	public static final RegistryObject<Item> SSSR = REGISTRY.register("sssr", () -> new SSSRItem());
	public static final RegistryObject<Item> STALIN_SPAWN_EGG = REGISTRY.register("stalin_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.STALIN, -65536, -11776, new Item.Properties()));
	public static final RegistryObject<Item> RICK_ASTLEY_SPAWN_EGG = REGISTRY.register("rick_astley_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.RICK_ASTLEY, -1, -1, new Item.Properties()));
	public static final RegistryObject<Item> BACKROOMS_LVL_1_WALL = block(PurechaosModBlocks.BACKROOMS_LVL_1_WALL);
	...
	public static final RegistryObject<Item> LONG_LEG_CHICKEN_SPAWN_EGG = REGISTRY.register("long_leg_chicken_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.LONG_LEG_CHICKEN, -3355444, -16777216, new Item.Properties()));
	public static final RegistryObject<Item> FIREFLY_SPAWN_EGG = REGISTRY.register("firefly_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.FIREFLY, -16777216, -13261, new Item.Properties()));
	public static final RegistryObject<Item> TOTEM_OF_AMOGUS = REGISTRY.register("totem_of_amogus", () -> new TotemOfAmogusItem());
	public static final RegistryObject<Item> DEPRESSION_BLOCK = block(PurechaosModBlocks.DEPRESSION_BLOCK);
	public static final RegistryObject<Item> T_POSE_ENTITY_SPAWN_EGG = REGISTRY.register("t_pose_entity_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.T_POSE_ENTITY, -1, -16777216, new Item.Properties()));
	...
	public static final RegistryObject<Item> COMUNISAM_BLOCK = block(PurechaosModBlocks.COMUNISAM_BLOCK);
	public static final RegistryObject<Item> POLAND_BLOCK = block(PurechaosModBlocks.POLAND_BLOCK);
	public static final RegistryObject<Item> CYBER_BLOCK = block(PurechaosModBlocks.CYBER_BLOCK);
	public static final RegistryObject<Item> TOTEM_OF_DREAM = REGISTRY.register("totem_of_dream", () -> new TotemOfDreamItem());
	public static final RegistryObject<Item> COMPUTER = block(PurechaosModBlocks.COMPUTER);
	...
	public static final RegistryObject<Item> GREENGISCREENDA = block(PurechaosModBlocks.GREENGISCREENDA);
	public static final RegistryObject<Item> FASTTOPASS = REGISTRY.register("fasttopass", () -> new FASTTOPASSItem());
	public static final RegistryObject<Item> STROATER_SPAWN_EGG = REGISTRY.register("stroater_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.STROATER, -6724096, -16777216, new Item.Properties()));
	...
	public static final RegistryObject<Item> SPONGEBOB_BOSS_SPAWN_EGG = REGISTRY.register("spongebob_boss_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.SPONGEBOB_BOSS, -256, -3355648, new Item.Properties()));
	...
	public static final RegistryObject<Item> ADIDAS_BLOCK = block(PurechaosModBlocks.ADIDAS_BLOCK);
	public static final RegistryObject<Item> ADIDAS_AXE = REGISTRY.register("adidas_axe", () -> new AdidasAxeItem());
	public static final RegistryObject<Item> AMOGUS_3_BLU_SPAWN_EGG = REGISTRY.register("amogus_3_blu_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AMOGUS_3_BLU, -52429, -13382401, new Item.Properties()));
	...
	public static final RegistryObject<Item> AMOGUS_3_GRIN_SPAWN_EGG = REGISTRY.register("amogus_3_grin_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AMOGUS_3_GRIN, -52429, -10027162, new Item.Properties()));
	public static final RegistryObject<Item> MISSING_TEXTURE = block(PurechaosModBlocks.MISSING_TEXTURE);
	public static final RegistryObject<Item> THE_ROCK_SPAWN_EGG = REGISTRY.register("the_rock_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.THE_ROCK, -3394816, -52480, new Item.Properties()));
	...
	public static final RegistryObject<Item> BIG_SPAWN_EGG = REGISTRY.register("big_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.BIG, -16777216, -3355648, new Item.Properties()));
	...
	public static final RegistryObject<Item> JEB_BLOCK = block(PurechaosModBlocks.JEB_BLOCK);
	...
	public static final RegistryObject<Item> TECHNOBLADE_SPAWN_EGG = REGISTRY.register("technoblade_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.TECHNOBLADE, -39271, -3342541, new Item.Properties()));
	public static final RegistryObject<Item> CUPCAKKE_SPAWN_EGG = REGISTRY.register("cupcakke_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.CUPCAKKE, -1, -1, new Item.Properties()));
	...
	public static final RegistryObject<Item> BALDI_MINUS_SPAWN_EGG = REGISTRY.register("baldi_minus_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.BALDI_MINUS, -11618049, -16711936, new Item.Properties()));
	public static final RegistryObject<Item> HEROBRINE_SPAWN_EGG = REGISTRY.register("herobrine_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.HEROBRINE, -1, -9777153, new Item.Properties()));
	...
	public static final RegistryObject<Item> NERD_SPAWN_EGG = REGISTRY.register("nerd_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.NERD, -205, -3355444, new Item.Properties()));
	public static final RegistryObject<Item> SUSSY_SUS_STEW = REGISTRY.register("sussy_sus_stew", () -> new SussySusStewItem());
	public static final RegistryObject<Item> IRS_SPAWN_EGG = REGISTRY.register("irs_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.IRS, -13312, -16776961, new Item.Properties()));
	public static final RegistryObject<Item> FBI_SPAWN_EGG = REGISTRY.register("fbi_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.FBI, -10066330, -16777216, new Item.Properties()));
	public static final RegistryObject<Item> AMERICAN_SOLDAT_SPAWN_EGG = REGISTRY.register("american_soldat_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.AMERICAN_SOLDAT, -6684826, -10066330, new Item.Properties()));
	public static final RegistryObject<Item> MURICA_SPAWN_EGG = REGISTRY.register("murica_spawn_egg", () -> new ForgeSpawnEggItem(PurechaosModEntities.MURICA, -13421569, -65536, new Item.Properties()));
