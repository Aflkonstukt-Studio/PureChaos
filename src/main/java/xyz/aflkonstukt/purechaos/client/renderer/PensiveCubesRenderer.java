...
public class PensiveCubesRenderer extends GeoEntityRenderer<PensiveCubesEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PensiveCubesEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
