...
import xyz.aflkonstukt.purechaos.procedures.BleachOverlayDisplayOverlayIngameProcedure;
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (BleachOverlayDisplayOverlayIngameProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("purechaos:textures/screens/white_screen.png"));
