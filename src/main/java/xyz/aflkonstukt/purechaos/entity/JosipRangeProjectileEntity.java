...
public class JosipRangeProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public JosipRangeProjectileEntity(EntityType<? extends JosipRangeProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public JosipRangeProjectileEntity(EntityType<? extends JosipRangeProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static JosipRangeProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		JosipRangeProjectileEntity entityarrow = new JosipRangeProjectileEntity(PurechaosModEntities.JOSIP_RANGE_PROJECTILE.get(), entity, world, null);
	...
	public static JosipRangeProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		JosipRangeProjectileEntity entityarrow = new JosipRangeProjectileEntity(PurechaosModEntities.JOSIP_RANGE_PROJECTILE.get(), entity, entity.level(), null);
