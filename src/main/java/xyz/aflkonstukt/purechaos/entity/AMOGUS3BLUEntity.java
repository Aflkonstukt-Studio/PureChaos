...
public class AMOGUS3BLUEntity extends Monster {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PurechaosModEntities.AMOGUS_3_BLU.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
