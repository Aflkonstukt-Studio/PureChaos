...
public class RickAstleyEntity extends Monster {
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("purechaos:never_gonna_give_you_up"));
	}
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.RICK_ASTLEY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
