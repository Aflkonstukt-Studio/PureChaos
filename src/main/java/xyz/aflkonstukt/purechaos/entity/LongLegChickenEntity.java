...
public class LongLegChickenEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(PurechaosModEntities.LONG_LEG_CHICKEN.get(), 50, 2, 4));
	}
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.LONG_LEG_CHICKEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
