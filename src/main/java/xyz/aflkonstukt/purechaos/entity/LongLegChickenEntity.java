...
public class LongLegChickenEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.LONG_LEG_CHICKEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
