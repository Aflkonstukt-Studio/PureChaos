...
public class LongLegChickenEntity extends Monster {
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("purechaos:girl_moan"));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PurechaosModEntities.LONG_LEG_CHICKEN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
