...
import xyz.aflkonstukt.purechaos.procedures.MeteorOnEntityTickUpdateProcedure;
import xyz.aflkonstukt.purechaos.procedures.MeteorEntityFallsProcedure;
...
public class MeteorEntity extends PathfinderMob {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PurechaosModEntities.METEOR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
