...
public class IRSEntity extends PathfinderMob {
	public IRSEntity(EntityType<IRSEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("IRS Agent"));
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.IRS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
