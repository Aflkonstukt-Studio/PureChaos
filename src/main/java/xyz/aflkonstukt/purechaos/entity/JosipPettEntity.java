...
public class JosipPettEntity extends TamableAnimal implements RangedAttackMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(PurechaosModEntities.JOSIP_PETT.get(), 40, 1, 3));
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				Random random = JosipPettEntity.this.getRandom();
	...
	public boolean isFood(ItemStack stack) {
		return List.of(PurechaosModBlocks.GREEN_PLANT.get().asItem()).contains(stack.getItem());
	}
