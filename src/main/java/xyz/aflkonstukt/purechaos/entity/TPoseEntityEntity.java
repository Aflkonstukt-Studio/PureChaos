...
public class TPoseEntityEntity extends Monster implements RangedAttackMob {
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PurechaosModItems.IMPOSTOR_KNIFE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.T_POSE_ENTITY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
