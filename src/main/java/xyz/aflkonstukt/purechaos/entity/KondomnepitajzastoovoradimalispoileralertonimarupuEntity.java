...
public class KondomnepitajzastoovoradimalispoileralertonimarupuEntity extends AbstractArrow implements ItemSupplier {
	public KondomnepitajzastoovoradimalispoileralertonimarupuEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PurechaosModEntities.KONDOMNEPITAJZASTOOVORADIMALISPOILERALERTONIMARUPU.get(), world);
	}
	...
	public static KondomnepitajzastoovoradimalispoileralertonimarupuEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		KondomnepitajzastoovoradimalispoileralertonimarupuEntity entityarrow = new KondomnepitajzastoovoradimalispoileralertonimarupuEntity(PurechaosModEntities.KONDOMNEPITAJZASTOOVORADIMALISPOILERALERTONIMARUPU.get(), entity, world);
	...
	public static KondomnepitajzastoovoradimalispoileralertonimarupuEntity shoot(LivingEntity entity, LivingEntity target) {
		KondomnepitajzastoovoradimalispoileralertonimarupuEntity entityarrow = new KondomnepitajzastoovoradimalispoileralertonimarupuEntity(PurechaosModEntities.KONDOMNEPITAJZASTOOVORADIMALISPOILERALERTONIMARUPU.get(), entity, entity.level);
