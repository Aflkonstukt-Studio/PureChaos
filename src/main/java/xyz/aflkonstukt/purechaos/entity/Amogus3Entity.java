...
public class Amogus3Entity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.AMOGUS_3.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
