...
public class Amogus3Entity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(PurechaosModEntities.AMOGUS_3.get(), 60, 1, 3));
	}

	public Amogus3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(PurechaosModEntities.AMOGUS_3.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(PurechaosModEntities.AMOGUS_3.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(PurechaosModEntities.AMOGUS_3.get(), 180);
	}
