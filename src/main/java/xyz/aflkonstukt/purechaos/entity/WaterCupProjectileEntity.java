...
public class WaterCupProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public WaterCupProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PurechaosModEntities.WATER_CUP_PROJECTILE.get(), world);
	}
	...
	public static WaterCupProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
