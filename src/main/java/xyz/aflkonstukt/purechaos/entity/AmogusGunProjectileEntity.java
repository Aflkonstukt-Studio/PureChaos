...
public class AmogusGunProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public AmogusGunProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PurechaosModEntities.AMOGUS_GUN_PROJECTILE.get(), world);
	}
	...
	public AmogusGunProjectileEntity(EntityType<? extends AmogusGunProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public AmogusGunProjectileEntity(EntityType<? extends AmogusGunProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public static AmogusGunProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AmogusGunProjectileEntity entityarrow = new AmogusGunProjectileEntity(PurechaosModEntities.AMOGUS_GUN_PROJECTILE.get(), entity, world);
	...
	public static AmogusGunProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AmogusGunProjectileEntity entityarrow = new AmogusGunProjectileEntity(PurechaosModEntities.AMOGUS_GUN_PROJECTILE.get(), entity, entity.level());
