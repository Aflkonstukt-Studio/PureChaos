...
public class RadiationLiquidItem extends BucketItem {
	public RadiationLiquidItem() {
		super(PurechaosModFluids.RADIATION_LIQUID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON).tab(PurechaosModTabs.TAB_CHAOSTAB));
	}
}
