...
import xyz.aflkonstukt.purechaos.procedures.UseInEmergenciesRightclickedProcedure;
...
public class UseInEmergenciesItem extends Item {
	public UseInEmergenciesItem() {
		super(new Item.Properties().tab(PurechaosModTabs.TAB_CHAOSTAB).stacksTo(1).rarity(Rarity.EPIC));
	}
