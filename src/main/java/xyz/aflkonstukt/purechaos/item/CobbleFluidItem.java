...
public class CobbleFluidItem extends BucketItem {
	public CobbleFluidItem() {
		super(PurechaosModFluids.COBBLE_FLUID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON).tab(PurechaosModTabs.TAB_CHAOSTAB));
	}
}
