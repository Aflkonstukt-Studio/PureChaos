...
public record AdGUIButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	}, (RegistryFriendlyByteBuf buffer) -> new AdGUIButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), readTextState(buffer)));
	@Override
	public Type<AdGUIButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final AdGUIButtonMessage message, final IPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PurechaosMod.addNetworkMessage(AdGUIButtonMessage.TYPE, AdGUIButtonMessage.STREAM_CODEC, AdGUIButtonMessage::handleData);
	}
}
