...
public record ComputerGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PurechaosMod.MODID, "computer_gui_buttons");
	...
	public static void handleData(final ComputerGuiButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PurechaosMod.addNetworkMessage(ComputerGuiButtonMessage.ID, ComputerGuiButtonMessage::new, ComputerGuiButtonMessage::handleData);
	}
}
