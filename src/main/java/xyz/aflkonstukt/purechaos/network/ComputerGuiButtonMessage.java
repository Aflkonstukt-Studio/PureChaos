...
public class ComputerGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			EnterCyberspaceButtonPressedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		PurechaosMod.addNetworkMessage(ComputerGuiButtonMessage.class, ComputerGuiButtonMessage::buffer, ComputerGuiButtonMessage::new, ComputerGuiButtonMessage::handler);
	}
}
