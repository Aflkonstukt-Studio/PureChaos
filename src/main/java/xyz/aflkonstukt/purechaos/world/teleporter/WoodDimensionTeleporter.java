...
public class WoodDimensionTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("purechaos:wood_dimension_portal"), poiType);
	...
	public WoodDimensionTeleporter(ServerLevel level) {
		this.level = level;
	}
