...
public class WoodDimensionTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("wood_dimension_portal", com.google.common.collect.Sets.newHashSet(ImmutableSet.copyOf(PurechaosModBlocks.WOOD_DIMENSION_PORTAL.get().getStateDefinition().getPossibleStates())), 0, 1)
				.setRegistryName("wood_dimension_portal");
