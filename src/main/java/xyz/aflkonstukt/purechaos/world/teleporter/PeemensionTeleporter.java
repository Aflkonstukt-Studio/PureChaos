...
public class PeemensionTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("purechaos:peemension_portal"), poiType);
	...
	public PeemensionTeleporter(ServerLevel level) {
		this.level = level;
	}
