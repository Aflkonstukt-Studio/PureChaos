...
public class MoreExtremeHillsBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("purechaos:tree_more_extreme_hills",
						FeatureUtils.register("purechaos:tree_more_extreme_hills", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("purechaos:grass_more_extreme_hills", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("purechaos:flower_more_extreme_hills", VegetationFeatures.FLOWER_DEFAULT,
