...
public class EmepeeFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("purechaos:emepee", FEATURE, new OreConfiguration(EmepeeFeatureRuleTest.INSTANCE, PurechaosModBlocks.EMEPEE.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("purechaos:emepee", CONFIGURED_FEATURE,
	...
	private static class EmepeeFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("purechaos:emepee_match"), CUSTOM_MATCH);
		}
