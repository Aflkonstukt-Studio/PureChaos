...
public class SADsFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("purechaos:sa_ds", FEATURE, new OreConfiguration(SADsFeatureRuleTest.INSTANCE, PurechaosModBlocks.SA_DS.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("purechaos:sa_ds", CONFIGURED_FEATURE,
	...
	private static class SADsFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("purechaos:sa_ds_match"), CUSTOM_MATCH);
		}
