...
public class PeeBlockFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("purechaos:pee_block", FEATURE, new OreConfiguration(PeeBlockFeatureRuleTest.INSTANCE, PurechaosModBlocks.PEE_BLOCK.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("purechaos:pee_block", CONFIGURED_FEATURE,
	...
	private static class PeeBlockFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("purechaos:pee_block_match"), CUSTOM_MATCH);
		}
