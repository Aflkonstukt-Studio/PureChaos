...
public class DeathFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("purechaos:death", FEATURE, new OreConfiguration(DeathFeatureRuleTest.INSTANCE, PurechaosModBlocks.DEATH.get().defaultBlockState(), 3));
		PLACED_FEATURE = PlacementUtils.register("purechaos:death", CONFIGURED_FEATURE,
	...
	private static class DeathFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("purechaos:death_match"), CUSTOM_MATCH);
		}
