...
public class AdidasBlockFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("purechaos:adidas_block", FEATURE, new OreConfiguration(AdidasBlockFeatureRuleTest.INSTANCE, PurechaosModBlocks.ADIDAS_BLOCK.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("purechaos:adidas_block", CONFIGURED_FEATURE,
	...
	private static class AdidasBlockFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("purechaos:adidas_block_match"), CUSTOM_MATCH);
		}
