...
public class Amogus3CrewGRINEntity extends Monster {
	...
	public Amogus3CrewGRINEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChaosmodModEntities.AMOGUS_3_CREW_GRIN.get(), world);
	}

	public Amogus3CrewGRINEntity(EntityType<Amogus3CrewGRINEntity> type, Level world) {
		super(type, world);
		xpReward = 99999;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(ChaosmodModEntities.AMOGUS_3_CREW_GRIN.get(), SpawnPlacements.Type.ON_GROUND,
				Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL
						&& Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));

		DungeonHooks.addDungeonMob(ChaosmodModEntities.AMOGUS_3_CREW_GRIN.get(), 180);
	}
