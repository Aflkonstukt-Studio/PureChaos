...
public class JOSIPEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(ChaosmodModEntities.JOSIP.get(), 20, 4, 4));
	}
	...
	public JOSIPEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChaosmodModEntities.JOSIP.get(), world);
	}
	...
	public JOSIPEntity(EntityType<JOSIPEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ChaosmodModItems.SUS_SWORD.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(ChaosmodModItems.SUS_SWORD.get()));
	...
	public static void init() {
		SpawnPlacements.register(ChaosmodModEntities.JOSIP.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
