...
public class StaravodaFeatureFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("chaosmod:staravoda_feature", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(ChaosmodModBlocks.STARAVODA.get().defaultBlockState()), BlockStateProvider.simple(Blocks.AIR.defaultBlockState())));
		PLACED_FEATURE = PlacementUtils.register("chaosmod:staravoda_feature", CONFIGURED_FEATURE, List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(),
