...
public class RickrollStairsFeature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("chaosmod:rickroll_stairs", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("chaosmod:rickroll_stairs", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("chaosmod", "rick_roll_stairs"));
		if (template == null)
			return false;
