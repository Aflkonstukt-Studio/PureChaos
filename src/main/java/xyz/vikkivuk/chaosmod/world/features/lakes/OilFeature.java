...
public class OilFeature extends LakeFeature {
	public static OilFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new OilFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("chaosmod:oil", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(ChaosmodModBlocks.OIL.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("chaosmod:oil", CONFIGURED_FEATURE,
