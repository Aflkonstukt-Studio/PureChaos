...
public class Modeljosipmmarket<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("chaosmod", "modeljosipmmarket"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(2, 5).addBox(-2.75F, -1.0F, -0.1F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, -3.0F, 0.0F, 0.0F, 0.48F));
