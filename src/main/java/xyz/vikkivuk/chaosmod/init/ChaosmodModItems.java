...
public class ChaosmodModItems {
	...
	public static final RegistryObject<Item> AENTITY_SPAWN_EGG = REGISTRY.register("aentity_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.AENTITY, -13434625, -10040065, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> TRIDENT_SPAWN_EGG = REGISTRY.register("trident_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.TRIDENT, -13641874, -1, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> AMONG_US_SPAWN_EGG = REGISTRY.register("among_us_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.AMONG_US, -52429, -3394816, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> AMOGUS_2_SPAWN_EGG = REGISTRY.register("amogus_2_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.AMOGUS_2, -26215, -52429, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> AMOGUS_3_SPAWN_EGG = REGISTRY.register("amogus_3_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.AMOGUS_3, -52429, -39322, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> SPLANK_SPAWN_EGG = REGISTRY.register("splank_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.SPLANK, -3355648, -154, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> FALLGAYS = REGISTRY.register("fallgays", () -> new FallgaysItem());
	public static final RegistryObject<Item> IKEA_DESK_SPAWN_EGG = REGISTRY.register("ikea_desk_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.IKEA_DESK, -13421773, -1, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> JOSIP_SPAWN_EGG = REGISTRY.register("josip_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.JOSIP, -3407617, -16777216, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> JOSIPDVATOCKANULA_SPAWN_EGG = REGISTRY.register("josipdvatockanula_spawn_egg",
			() -> new ForgeSpawnEggItem(ChaosmodModEntities.JOSIPDVATOCKANULA, -16777216, -65536, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> JOSIP_PET_SPAWN_EGG = REGISTRY.register("josip_pet_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.JOSIP_PET, -3407668, -26113, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> JOSIP_PETT_SPAWN_EGG = REGISTRY.register("josip_pett_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.JOSIP_PETT, -65536, -10066330, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> MOTH_OF_AGGREVATION_SPAWN_EGG = REGISTRY.register("moth_of_aggrevation_spawn_egg",
			() -> new ForgeSpawnEggItem(ChaosmodModEntities.MOTH_OF_AGGREVATION, -6737152, -1, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> AK_47 = REGISTRY.register("ak_47", () -> new AK47Item());
	public static final RegistryObject<Item> CURSED_DOG_SPAWN_EGG = REGISTRY.register("cursed_dog_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.CURSED_DOG, -1, -3355444, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> BLAZ_SPAWN_EGG = REGISTRY.register("blaz_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.BLAZ, -205, -39322, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> SHEP_SPAWN_EGG = REGISTRY.register("shep_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.SHEP, -1, -10066330, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> BULLET = REGISTRY.register("bullet", () -> new BulletItem());
	public static final RegistryObject<Item> VIKKIVUK_SPAWN_EGG = REGISTRY.register("vikkivuk_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.VIKKIVUK, -13369345, -13408513, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> DREAM_SPAWN_EGG = REGISTRY.register("dream_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.DREAM, -13369549, -1, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> WALTER_WIGHT_SPAWN_EGG = REGISTRY.register("walter_wight_spawn_egg",
			() -> new ForgeSpawnEggItem(ChaosmodModEntities.WALTER_WIGHT, -16777012, -16777114, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> STALIN_SPAWN_EGG = REGISTRY.register("stalin_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.STALIN, -65536, -11776, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> RICK_ASTLEY_SPAWN_EGG = REGISTRY.register("rick_astley_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.RICK_ASTLEY, -1, -1, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> LEGS_SPAWN_EGG = REGISTRY.register("legs_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.LEGS, -26368, -205, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> LONG_LEG_CHICKEN_SPAWN_EGG = REGISTRY.register("long_leg_chicken_spawn_egg",
			() -> new ForgeSpawnEggItem(ChaosmodModEntities.LONG_LEG_CHICKEN, -3355444, -16777216, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> FIREFLY_SPAWN_EGG = REGISTRY.register("firefly_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.FIREFLY, -16777216, -13261, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> STROATER_SPAWN_EGG = REGISTRY.register("stroater_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.STROATER, -6724096, -16777216, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> AMOGUS_3_BLU_SPAWN_EGG = REGISTRY.register("amogus_3_blu_spawn_egg",
			() -> new ForgeSpawnEggItem(ChaosmodModEntities.AMOGUS_3_BLU, -52429, -13382401, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	public static final RegistryObject<Item> AMOGUS_3_GRIN_SPAWN_EGG = REGISTRY.register("amogus_3_grin_spawn_egg",
			() -> new ForgeSpawnEggItem(ChaosmodModEntities.AMOGUS_3_GRIN, -52429, -10027162, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> THE_ROCK_SPAWN_EGG = REGISTRY.register("the_rock_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.THE_ROCK, -3394816, -52480, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
	...
	public static final RegistryObject<Item> BIG_SPAWN_EGG = REGISTRY.register("big_spawn_egg", () -> new ForgeSpawnEggItem(ChaosmodModEntities.BIG, -16777216, -3355648, new Item.Properties().tab(ChaosmodModTabs.TAB_CHAOSTAB)));
