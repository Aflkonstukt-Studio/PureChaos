...
import xyz.vikkivuk.chaosmod.world.biome.PlainsBiome;
import xyz.vikkivuk.chaosmod.world.biome.OhioBiome;
import xyz.vikkivuk.chaosmod.world.biome.MoreExtremeHillsBiome;
...
import xyz.vikkivuk.chaosmod.world.biome.DesertBiome;
import xyz.vikkivuk.chaosmod.world.biome.CyberBiomeBiome;
import xyz.vikkivuk.chaosmod.world.biome.BirchForestBiome;
			...
			if (dimensionType == dimensionTypeRegistry.getOrThrow(DimensionType.OVERWORLD_LOCATION)) {
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					...
					if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
						...
						surfaceRules.add(1,
								preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, SUSUS.getId()), Blocks.GRASS_BLOCK.defaultBlockState(), ChaosmodModBlocks.SUS_BLOCK.get().defaultBlockState(), Blocks.OAK_PLANKS.defaultBlockState()));
