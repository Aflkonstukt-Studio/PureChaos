...
public class Modelthe_rock<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "the_rock"), "main");
	private final ModelPart darocksus;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition darocksus = partdefinition.addOrReplaceChild("darocksus", CubeListBuilder.create(),
				PartPose.offset(-8.0F, 16.0F, 8.0F));

		PartDefinition darocksus_0_r1 = darocksus.addOrReplaceChild(
				"darocksus_0_r1", CubeListBuilder.create().texOffs(-16, 0).addBox(-8.0F, -0.0452F, 0.0F, 16.0F, 0.0F,
