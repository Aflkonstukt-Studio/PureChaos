...
public class Modelspongebob_boss<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "spongebob_boss"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition eyes = partdefinition.addOrReplaceChild("eyes",
				CubeListBuilder.create().texOffs(10, 33)
						.addBox(-5.0F, -23.0F, -3.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(1.0F, -23.0F, -3.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_hand = arms.addOrReplaceChild("left_hand",
				CubeListBuilder.create().texOffs(33, 27)
						.addBox(7.0F, -17.0F, -1.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 29)
		...
		PartDefinition right_hand = arms.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(30, 13)
						.addBox(7.0F, -17.0F, -1.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 6)
						...
						.addBox(11.0F, -17.0F, 0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 21)
						.addBox(9.0F, -23.0F, -3.3F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = left_leg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(30, 6)
						.addBox(-3.0F, -4.0F, 2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 21)
						.addBox(-3.0F, -1.0F, 1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 27)
						.addBox(-4.0F, -7.0F, 1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = right_leg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(28, 33)
						.addBox(-3.0F, -4.0F, 2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 21)
						.addBox(-3.0F, -1.0F, 1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
						.addBox(-4.0F, -7.0F, 1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.0F, -25.0F, -2.0F, 12.0F, 18.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
						.addBox(-0.5F, -19.0F, -4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
