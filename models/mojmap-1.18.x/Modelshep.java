...
public class Modelshep<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shep"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -10.0F, -7.0F, 8.0F, 16.0F, 34.0F, new CubeDeformation(1.75F)).texOffs(0, 0)
		...
		PartDefinition leg0 = body.addOrReplaceChild("leg0",
				CubeListBuilder.create().texOffs(44, 50)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 64)
		...
		PartDefinition leg1 = body.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(28, 50)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 64)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offset(3.0F, 7.0F, 5.0F));

		PartDefinition leg2 = body.addOrReplaceChild("leg2",
				CubeListBuilder.create().texOffs(50, 16)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 60)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offset(-3.0F, 7.0F, -7.0F));

		PartDefinition leg3 = body.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(50, 0)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 50)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offset(3.0F, 7.0F, -7.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 50)
						.addBox(-3.0F, -4.0F, -6.0F, 6.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 22)
