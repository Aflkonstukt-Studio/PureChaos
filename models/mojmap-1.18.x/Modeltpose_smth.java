...
public class Modeltpose_smth<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tpose_smth"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightArm_r1 = rightArm.addOrReplaceChild("rightArm_r1",
				CubeListBuilder.create().texOffs(40, 16).addBox(20.0F, 4.0F, -2.0F, 4.0F, 12.0F, 4.0F,
		...
		PartDefinition rightArm_r2 = rightArm
				.addOrReplaceChild("rightArm_r2",
						CubeListBuilder.create().texOffs(40, 16).addBox(-24.0F, 4.0F, -2.0F, 4.0F, 12.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, 0.0F, 0.0F, 1.5708F));
